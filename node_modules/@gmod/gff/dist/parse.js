        ...
        ids.forEach(function (id) {
            ...
            if (existing) {
                ...
                if (existing[existing.length - 1].type !== featureLine.type) {
                    _this._parseError("multi-line feature \"".concat(id, "\" has inconsistent types: \"").concat(featureLine.type, "\", \"").concat(existing[existing.length - 1].type, "\""));
                }
    ...
    Parser.prototype._resolveReferencesFrom = function (feature, references, ids) {
        ...
        references.Parent.forEach(function (toId) {
            ...
            if (otherFeature) {
                ...
                if (!ids.filter(function (id) {
                    return postSet(_this._completedReferences, id, "Parent,".concat(toId));
                }).length) {
        ...
        references.Derives_from.forEach(function (toId) {
            ...
            if (otherFeature) {
                ...
                if (!ids.filter(function (id) {
                    return postSet(_this._completedReferences, id, "Derives_from,".concat(toId));
                }).length) {
                    otherFeature.forEach(function (location) {
